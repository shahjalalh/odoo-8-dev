...
class Tag(models.Model):
	...
	child_ids = field.One2many('todo.task.tag', 'parent_id', 'Child Tags')

class Stage(modles.Model):
	...
	state = fields.Selection([('draft', 'New'), ('open', 'Started'), ('done', 'Closed')],
		'State',
...
class TodoTask(models.Model):
	...
	user_todo_count = fields.Interger(
		'User To-Do Count',
